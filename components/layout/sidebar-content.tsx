...
import { LayoutDashboard, Package, ArrowLeftRight, Settings, LogOut, Building2, BarChart3, FileText, Store, Users, Megaphone, Globe } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Minha Loja', href: '/minha-loja', icon: Globe },
